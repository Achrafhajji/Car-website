...
{
    public class BuycarController : ApiController
    {
        ...
        public IHttpActionResult GetCars()
        {
            string query = "SELECT Vehicule_ID, Vehicule_Make, Vehicule_Model, Vehicule_Year, Vehicule_Horsepower, Vehicule_Kilometrage, Vehicule_FirstHand, Vehicule_DoorsNumber," +
                ...
                " DATEDIFF(MINUTE, PostingTime, GETDATE()) AS TimeDifferenceInMinutes FROM Vehicule";
    ...
    public partial class Vehicule
    {
        ...
        public string Vehicule_Pictures { get; set; }
        public string Vehicule_Description { get; set; }
        public DateTime PostingTime { get; set; }
        public string TimeDifference { get; set; }

        public string FormattedVehicule_Kilometrage
        {
            get
            {
                return Vehicule_Kilometrage.ToString("#,##0");
            }
        }

        public string FormattedVehicule_SellPrice
        {
            get
            {
                return Vehicule_SellPrice.ToString("#,##0");
            }
        }
    }
}
